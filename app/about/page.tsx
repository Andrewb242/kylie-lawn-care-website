  ...
  return (
    <div className="container mx-auto px-4 space-y-8 py-10">
      ...
      <div>
        ...
        <p>We’re grounded in values that guide every job we take on:</p>
        <div className="mx-auto max-w-xl grid grid-cols-1 md:grid-cols-2 gap-4 py-10">
          <ValueCard
            title="Reliability"
          ...
          <ValueCard title="Care" icon={<FiHeart height={28} width={28} />}>
            We’re a family business, and we treat our clients like they’re part
            of that family.
          </ValueCard>
          <ValueCard
            title="Respect"
        ...
        <p className="mt-3">
          Whether we’re mowing your lawn or helping clean up after a storm, you
          can count on us to work hard, communicate clearly, and always put your
          satisfaction first.
        </p>
      </div>
    </div>
